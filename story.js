...
function press(){
 ...
 function talk(){
   document.getElementById("bg").style.backgroundImage = "url('land5.JPG')"
     ...
     document.getElementById("story").innerHTML="''Excuse me miss, what is the date today?'' You say. ''Uh'' she checks her phone, ''today is July 25th, 2017.'' You thank her and walk out of the park and pass a newspaper stand. The headline on the newspaper says: ''LAST CHANCE TO SAVE OUR PLANET FROM CLIMATE CHANGE!'' As you continue your stroll, you realize that this is an opportunity to make a difference and reverse the environmental damage of the past. You begin your course towards the Environmental Protection Agency, determined to show government officials the drastic transformation that will occur in the near future if people don’t change their ways. You arrive at the agency and show them pictures from the future. At the sight of such horrific conditions they wonder what they can do so everyone can grow up in a healthy world. ''Well, what do you think we can do to save the planet?'' <br><br> Here is a checklist, choose all options that can help the environment!" 
 }
